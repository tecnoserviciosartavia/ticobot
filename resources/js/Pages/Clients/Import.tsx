            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Sube un archivo CSV con las columnas: name, email, phone, status, notes.</p>
                    </div>
                    <Link
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            <div>
                                ...
                                <p className="mt-2 text-xs text-gray-500">
                                    Recomendado: CSV con encabezados. Columnas soportadas: name (obligatorio), email, phone, status, notes. Codificación UTF-8.
                                </p>
                            </div>
